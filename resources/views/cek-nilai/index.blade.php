                ...
                <div class="card">
                    <div class="card-header py-3">
                        <div class="row">
                            ...
                            <div class="col-6">
                                @if ($tahun_ajaran_id)
                                    <a href="{{ route('cetakLaporanSiswa', ['tahun_ajaran_id' => $tahun_ajaran_id]) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <form action="/cek-nilai/filter-data" method="GET">
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="ml-2 mt-1">
                                                            ...
                                                            <a href="/cek-nilai/" class="btn btn-sm btn-danger ml-1"
